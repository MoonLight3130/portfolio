        ...
        <nav className="hidden items-center gap-10 lg:flex">
          {navLinks.map((link) => (
            <button
              ...
              className={`text-[12px] font-medium uppercase tracking-[1.9px] transition duration-300 hover:text-[#00D9FF] ${activePage === pageMap[link]
                  ? 'text-[#00D9FF]'
                  : activePage === 'home' && (link === 'Home' || link === 'About')
                    ? 'text-white/82'
                    : 'text-white/82'
                }`}
            >
