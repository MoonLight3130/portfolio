...
const certifications = [
  ...
  {
    title: 'ML Models with BigQuery',
    org: 'Google',
    date: '2026',
    description: 'Completed Google Cloud Skill Badge: BigQuery ML for Machine Learning',
    skills: ['BigQuery ML', 'Machine learning', 'Forecasting', 'Dialogflow'],
    color: '#8B5CF6',
    url: 'https://www.credly.com/badges/dd4fc7b3-6d46-4d67-a129-5544da00fb02',
  },
  {
    title: 'Foundations for Understanding AI',
    org: 'IBM',
    date: '2026',
    description: 'Completed: AI Fundamentals and Foundations for Understanding AI',
    skills: ['Deep Learning', 'AI Prompting', 'Critical Thinking', 'Machine Learning'],
    color: '#00D9FF',
    url: 'https://www.credly.com/badges/52eda91a-f0b6-4252-be34-6d804ffd84fa',
  },
  {
    title: 'GitHub Copilot Fundamental',
    org: 'Microsoft',
    date: '2026',
    description: 'Completed GitHub Copilot Fundamentals.',
    skills: ['Prompt Engineering', 'Generative AI Tools', 'AI Pair Programming', 'GitHub Copilot'],
    color: '#8B5CF6',
    url: 'https://learn.microsoft.com/api/achievements/share/en-in/HaranSanthosh-1604/37UQADGH?sharingId=4418B5B0460688E9',
  },
  {
    title: 'Microsoft Copilot Foundation',
    org: 'Microsoft',
    date: '2026',
    description: 'Completed Copilot Foundations by Microsoft.',
    skills: ['AI Productivity', 'Microsoft Copilot', 'Software Development', 'Machine Learning'],
    color: '#00D9FF',
    url: 'https://learn.microsoft.com/api/achievements/share/en-in/HaranSanthosh-1604/XEFDP9JY?sharingId=4418B5B0460688E9',
  },
]
